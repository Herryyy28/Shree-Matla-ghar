        ...
        <div className="p-4 sm:p-5 flex flex-col flex-grow justify-between">
          <div className="flex flex-col justify-between flex-grow">
            <div>
              ...
              <p className="text-clay-600 text-xs mt-1 sm:mt-1.5 line-clamp-2 leading-relaxed min-h-[2.25rem]">
                {product.shortDescription}
              </p>

              {/* Sizes Pills */}
              <div className="mt-2.5 sm:mt-3 flex flex-wrap gap-1 min-h-[26px] items-center">
          ...
          <div className="mt-3.5 pt-3 border-t border-clay-100 space-y-2.5">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <span className="truncate">{isEnquired ? t.cta.addedToEnquiryShort : t.cta.addToEnquiryShort}</span>
              </button>
              ...
              >
                ...
                <span>{t.cta.whatsappQuoteShort}</span>
              </a>
            </div>
